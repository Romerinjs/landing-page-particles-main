            ...
            <div className="w-full max-w-3xl mx-auto md:pb-40 md:pt-20">
                <div className="-my-6">
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-6 sm:pl-10 group"> {/* Cambié pl-32 a pl-24 */}
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                        ...
                                        before:px-px before:bg-slate-300 sm:before:ml-[1rem]  {/* Cambié ml de 6.5rem a 5rem */}
                                        ...
                                        after:rounded-full sm:after:ml-[1rem] after:-translate-x-1/2 
